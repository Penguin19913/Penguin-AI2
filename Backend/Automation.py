...
from pywhatkit import search, playonyt # function for google search and youtube playback
...
# to store chatbot messages
messages = []

# system message to prove context to chatbot
...
def GoogleSearch(Topic):
    search(Topic) # use pywhatkit's search funtion
    return True


# Function to generate topic using ai and save it to a file
def Content(Topic):

    # nested function to open a file in notepad
    def OpenNotepad(File):
        default_text_editor = 'notepad.exe'   #'VSIXInstaller.exe' 
    ...
    def ContentWriterAI(prompt):
        ...
        Answer = Answer.replace("</s>", "") # remove unwanted tokens from the chunk
