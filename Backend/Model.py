...
# Initialize an empty list to store user message
messages = []

# This guides the AI model on how to categorize queries
preamble = """
...
ChatHistory = [
    ...
    {"role": "User", "message": "open microsoft edge and tell me about mahatama gandhi."},
    {"role": "Chatbot", "message": "open microsoft edge, general tell me about mahatama gandhi."},
...
def FirstLayerDMM(prompt: str = "test"):
    ...
    stream = co.chat_stream(
        ...
        connectors=[],  #No connectors are used
    ...
    # If '{query}' is in the response, recursively call the function for future clarification
...
if __name__ == "__main__":
    ...
    while True:
        print(FirstLayerDMM(input("Write your query >>>>")))